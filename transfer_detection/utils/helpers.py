...
import numpy as np
from utils.dataloaders import (full_path_loader, full_test_loader, CDDloader, LEVIRloader, get_cdd_split, get_levir_split)
...
def get_split_loaders(opt):
    train_dataset, test_dataset = get_cdd_split(opt)
    # train_dataset, test_dataset = get_levir_split(opt)
