...
class ResNet(nn.Module):
    ...
    def init_weights(self):
        ...
        if self.args.mode == 'random':
            pretrained = 'random'
        elif self.args.mode == 'imagenet':
            pretrained = 'resnet50-0676ba61.pth'
        elif self.args.mode == 'seco':
            pretrained = 'seco_resnet50_1m_modify.ckpt'
        elif self.args.mode == 'moco':
            pretrained = 'B3_rn50_moco_0099_ckpt_modify.pth'
        elif self.args.mode == 'tov':
            pretrained = 'pretrained_on_TOV-RS-balanced_ep800.pth.tar'
        elif self.args.mode == 'gersp':
            pretrained = 'GeRSP_200.pth'
        elif self.args.mode == 'pis-r50':
            pretrained = 'PIS-R50-IV16-E30-b128+SP.pt'
        else:
